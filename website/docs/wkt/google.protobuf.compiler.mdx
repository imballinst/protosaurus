...
```protosaurus--google.protobuf.compiler.CodeGeneratorRequest
message CodeGeneratorRequest {
  // The .proto files that were explicitly listed on the command-line.  The
// code generator should generate code only for these files.  Each file's
// descriptor will be included in proto_file, below.
  string file_to_generate = 1;
...
// fully qualified.
  FileDescriptorProto proto_file = 3;
...
```protosaurus--google.protobuf.compiler.CodeGeneratorResponse
...
```protosaurus--google.protobuf.compiler.File
message File {
...
```protosaurus--google.protobuf.compiler.Version
message Version {
  // 
  int32 major = 1;
  // 
